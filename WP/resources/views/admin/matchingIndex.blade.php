...
@foreach ($matchings as $matching)
    <tr>
        ...
        <td class="h-px w-px whitespace-nowrap">
            <div class="px-6 py-3">
                <span class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $matching->status }}</span>
            </div>
        </td>

        <td class="h-px w-px whitespace-nowrap">
            <div class="px-6 py-3">
                <span class="text-sm text-gray-500">{{ $matching->created_at->format('d M, H:i') }}</span>
            </div>
        </td>
