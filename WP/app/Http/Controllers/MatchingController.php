...
class MatchingController extends Controller
{
    ...
    return redirect()->route('matching.show',compact('posts', 'cat' )); // 適切なルートにリダイレクト
    }
    ...
    public function postShow($cat, Post $post)
    {
        ...
        public function postEdit(UserPost $userPost)
    {
        //
    }
     ...
     */
    public function postUpdate(Request $request, UserPost $userPost)
    {
        //
    }
     ...
     */
    public function postDestroy(UserPost $userPost)
    {
        //
    }
